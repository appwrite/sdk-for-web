...
class FFBrowserContext extends _browserContext.BrowserContext {
  ...
  async _initialize() {
    ...
    if (this._options.recordVideo) {
      promises.push(this._ensureVideosPath().then(() => {
        return this._browser._connection.send('Browser.setVideoRecordingOptions', { // validateBrowserContextOptions ensures correct video size.
  ...
  async _doExposeBinding(binding) {
    const worldName = binding.world === 'utility' ? _ffPage.UTILITY_WORLD_NAME : '';
