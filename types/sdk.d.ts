...
declare class Appwrite {
    ...
    account: {
         ...
         * @returns {Promise}
         */
        create: <Preferences_1 extends Models.Preferences>(userId: string, email: string, password: string, name?: string) => Promise<Models.User<Preferences_1>>;
        /**
         ...
         * @returns {Promise}
         */
        updatePassword: <Preferences_4 extends Models.Preferences>(password: string, oldPassword?: string) => Promise<Models.User<Preferences_4>>;
        /**
         ...
         * @returns {Promise}
         */
        getPrefs: <Preferences_5 extends Models.Preferences>() => Promise<Preferences_5>;
        /**
         ...
         * @returns {Promise}
         */
        updatePrefs: <Preferences_6 extends Models.Preferences>(prefs: object) => Promise<Models.User<Preferences_6>>;
        /**
         ...
         * @returns {Promise}
         */
        updateStatus: <Preferences_7 extends Models.Preferences>() => Promise<Models.User<Preferences_7>>;
        /**
    ...
    database: {
         ...
         * @returns {Promise}
         */
        listDocuments: <Document_1 extends Models.Document>(collectionId: string, queries?: string[], limit?: number, offset?: number, cursor?: string, cursorDirection?: string, orderAttributes?: string[], orderTypes?: string[]) => Promise<Models.DocumentList<Document_1>>;
        /**
         * Create Document
         *
         ...
         * @returns {Promise}
         */
        createDocument: <Document_2 extends Models.Document>(collectionId: string, documentId: string, data: object, read?: string[], write?: string[]) => Promise<Document_2>;
        /**
         * Get Document
         *
         ...
         * @returns {Promise}
         */
        getDocument: <Document_3 extends Models.Document>(collectionId: string, documentId: string) => Promise<Document_3>;
        /**
         * Update Document
         *
         ...
         * @returns {Promise}
         */
        updateDocument: <Document_4 extends Models.Document>(collectionId: string, documentId: string, data: object, read?: string[], write?: string[]) => Promise<Document_4>;
        /**
         * Delete Document
         *
...
declare type QueryTypesList = string[] | number[] | boolean[];
declare type QueryTypes = QueryTypesSingle | QueryTypesList;
declare class Query {
