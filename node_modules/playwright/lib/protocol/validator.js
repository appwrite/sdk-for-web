...
function createScheme(tChannel) {
  ...
  scheme.InterceptedResponse = (0, _validatorPrimitives.tObject)({
    ...
    headers: (0, _validatorPrimitives.tArray)((0, _validatorPrimitives.tObject)({
      name: _validatorPrimitives.tString,
      value: _validatorPrimitives.tString
    }))
  });
  scheme.PlaywrightSetForwardedPortsParams = (0, _validatorPrimitives.tObject)({
    ports: (0, _validatorPrimitives.tArray)(_validatorPrimitives.tNumber)
  });
  ...
  scheme.BrowserContextTracingExportParams = (0, _validatorPrimitives.tOptional)((0, _validatorPrimitives.tObject)({}));
  ...
  scheme.ResponseFinishedParams = (0, _validatorPrimitives.tOptional)((0, _validatorPrimitives.tObject)({}));
  ...
  scheme.SocksSocketWriteParams = (0, _validatorPrimitives.tObject)({
    data: _validatorPrimitives.tBinary
  });
  scheme.SocksSocketErrorParams = (0, _validatorPrimitives.tObject)({
    error: _validatorPrimitives.tString
  });
  scheme.SocksSocketConnectedParams = (0, _validatorPrimitives.tOptional)((0, _validatorPrimitives.tObject)({}));
  scheme.SocksSocketEndParams = (0, _validatorPrimitives.tOptional)((0, _validatorPrimitives.tObject)({}));
  return scheme;
}