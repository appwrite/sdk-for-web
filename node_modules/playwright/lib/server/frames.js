...
class FrameManager {
  ...
  requestFinished(request) {
    ...
    this._page._browserContext.emit(_browserContext.BrowserContext.Events.RequestFinished, request);
  }
...
class Frame extends _instrumentation.SdkObject {
  ...
  setPendingDocument(documentInfo) {
    ...
    if (documentInfo) this._invalidateNonStallingEvaluations();
  }
    ...
    return controller.run(async progress => {
      ...
      while (progress.isRunning()) {
        ...
        try {
          ...
          if (!js.isContextDestroyedError(e) && !e.message.includes(dom.kUnableToAdoptErrorMessage)) throw e;
          result.dispose();
        }
      }
...
class RerunnableTask {
  ...
  async rerun(context) {
    try {
      ...
      if (js.isContextDestroyedError(e)) return;
...
class SignalBarrier {
  ...
  release() {
    --this._protectCount;
    if (!this._protectCount) this._promiseCallback();
  }
