...
export class Waf {
     ...
     * @param {string} solution - Proof-of-work solution for the provided nonce.
     * @throws {AppwriteException}
     * @returns {Promise<Models.WafChallengeToken>}
