...
class CRExecutionContext {
  ...
  async rawEvaluateJSON(expression) {
    ...
    if (exceptionDetails) throw new Error('Evaluation failed: ' + (0, _crProtocolHelper.getExceptionMessage)(exceptionDetails));
...
function rewriteError(error) {
  ...
  if (js.isContextDestroyedError(error) || error.message.endsWith('Inspected target navigated or closed')) throw new Error('Execution context was destroyed, most likely because of a navigation.');
