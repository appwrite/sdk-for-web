...
exports.DispatcherConnection = exports.Dispatcher = exports.dispatcherSymbol = void 0;
...
class DispatcherConnection {
  ...
  async dispatch(message) {
    ...
    if (method === 'debugScopeState') {
      this.onmessage({
        id,
        result: this._rootDispatcher._debugScopeState()
      });
      return;
    }
    ...
    if (callMetadata.error) this.onmessage({
      id,
      error: error
    });else this.onmessage({
      id,
      result: callMetadata.result
    });
  }
