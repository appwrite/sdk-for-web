...
class BrowserContextDispatcher extends _dispatcher.Dispatcher {
  constructor(scope, context) {
    ...
    context.on(_browserContext.BrowserContext.Events.RequestFinished, request => this._dispatchEvent('requestFinished', {
  ...
  async newCDPSession(params) {
    ...
    return {
      session: new _cdpSessionDispatcher.CDPSessionDispatcher(this._scope, await crBrowserContext.newCDPSession(params.page._object))
    };
  }
