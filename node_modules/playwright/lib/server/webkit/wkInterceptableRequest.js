...
class WKRouteImpl {
  constructor(session, page, requestId) {
    ...
    this._requestInterceptedCallback = () => {};

    this._requestInterceptedPromise = void 0;
    ...
    this._requestInterceptedPromise = new Promise(f => this._requestInterceptedCallback = f);
  }
  ...
  async continue(request, overrides) {
    ...
    return new network.InterceptedResponse(request, responsePayload.status, responsePayload.statusText, (0, _utils.headersObjectToArray)(responsePayload.headers));
  }
