...
class Page extends _instrumentation.SdkObject {
  constructor(delegate, browserContext) {
    ...
    this._closedCallback = void 0;
    this._closedPromise = void 0;
    this._disconnected = false;
    this._initialized = false;
    this._disconnectedCallback = void 0;
    this._disconnectedPromise = void 0;
    this._crashedCallback = void 0;
    this._crashedPromise = void 0;
  ...
  async exposeBinding(name, needsHandle, playwrightBinding, world = 'main') {
    ...
    if (this._browserContext._pageBindings.has(identifier)) throw new Error(`Function "${name}" has been already registered in the browser context`);
  ...
  async close(metadata, options) {
    ...
    if (this._closedState !== 'closing') {
      ...
      (0, _utils.assert)(!this._disconnected, 'Protocol error: Connection closed. Most likely the page has been closed.'); // This might throw if the browser context containing the page closes
